...
- Linux: Ruby is available out-of-the-box in the [Ubuntu1804][ubuntu-ruby]
  operating system image.
- macOS: Ruby is available out-of-the-box in the [macOS][macos-ruby] OS image.
- Docker: use [semaphoreci/ruby][ruby-docker-image] or
  [your own Docker image][docker-env] with the version of Ruby and other
  packages that you need.

Follow the links above for details on currently available versions and
