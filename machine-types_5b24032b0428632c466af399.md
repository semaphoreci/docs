...
machine types in pipelines see pipeline [agent documentation][1].
...
**Note:** By default, you have 8 machines at your disposal per each type (24 total), but that capacity [can be increased](https://docs.semaphoreci.com/article/104-billing#plans).
