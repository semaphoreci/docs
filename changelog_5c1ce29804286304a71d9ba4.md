...
- Context of a [Github Status checks](https://developer.github.com/v3/repos/statuses/) was changed, to include information about a build source.
  - `ci/semaphoreci/push`
  - `ci/semaphoreci/pr`
  - `ci/semaphoreci/tag`
  
  Please update your settings if you are using [required status checks](https://help.github.com/en/articles/enabling-required-status-checks).
