...
that you do not want to make public in a Pipeline YAML file or files.
A secret is defined using a different
...
and files from an existing secret.
...
that was found in the secret that was imported last. The same applies to
files in secrets.
