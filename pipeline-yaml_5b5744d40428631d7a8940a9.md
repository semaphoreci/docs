...
The `name` property is a Unicode string that assigns a name to
the Semaphore 2.0 project and is compulsory.
...
Semaphore assigns its own names to nameless `blocks` items, which is what is
shown in the GUI.
