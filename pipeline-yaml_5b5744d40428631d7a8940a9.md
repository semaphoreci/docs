...
The `execution_time_limit` property can be used in two ways.
...
The following pipeline YAML file uses a combination of one global
`execution_time_limit` property and two local `execution_time_limit` properties:
