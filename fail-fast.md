...
One out of two Fail-Fast strategies can used:
...
[Difference between Stop and Cancel Fail-Fast strategies]()
[See also](#see-also)

## Stopping all jobs in a pipeline on first failure

To stop all the jobs in a pipeline on first failure, set a fail-fast stop
