...
- `macos-xcode13` ([reference][macos-xcode13])
...
If `pipeline_file` is an absolute path (starts with `/` character), Semaphore will seek the file inside `.semaphore` directory.
We do not support double dots (`..`) to traverse directories.
