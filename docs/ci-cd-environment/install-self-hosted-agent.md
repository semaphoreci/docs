...
```
curl -L https://github.com/semaphoreci/agent/releases/download/v2.2.15/agent_Linux_x86_64.tar.gz -o agent.tar.gz
tar -xf agent.tar.gz
```
...
```
curl -L https://github.com/semaphoreci/agent/releases/download/v2.2.15/agent_Darwin_x86_64.tar.gz -o agent.tar.gz
tar -xf agent.tar.gz
```
...
```
Invoke-WebRequest "https://github.com/semaphoreci/agent/releases/download/v2.2.15/agent_Windows_x86_64.tar.gz" -OutFile agent.tar.gz
