---
description: This guide describes how to setup the cache CLI to work with an AWS S3 bucket
---
...
<b>2. Create an AWS IAM policy</b>
...
<b>3. Create the AWS IAM user and its access keys:</b>
...
<b>4. Attach the AWS IAM policy to the AWS IAM user</b>
...
<b>1. Configure the `~/.aws` folder</b>
...
<b>2. Update the agent configuration</b>
...
Restart your agent and you should be able to start using your S3 bucket as a cache storage.

[setup aws cli]: https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-quickstart.html#cli-configure-quickstart-config
