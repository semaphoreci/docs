...
In this section you will see a `secret` example that uses a file.


Imagine that you have a file that you need to use as a secret.


Now, you can include that file in a `secret` as follows:
